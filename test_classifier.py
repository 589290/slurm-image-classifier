...
# -*- coding: utf-8 -*-
#                                                                             
# PURPOSE: To demonstrate the proper usage of the classifier() function that is defined in classifier.py This function uses CNN model 
#          architecture that has been pretrained on the ImageNet data to classify images. The only model architectures that this function 
...
# NOTE: image_classication is a text string - It contains mixed case(both lower and upper case letter)
# image labels that can be separated by commas when a label has more than one word that can describe it
